...
const Player = ({ item }) => {
  ...
  return (
    <div class="py-10 bg-gradient-to-br from-[#0000ff] to-[#090974]">  
        <article key={id} class='max-w-400'>
            <div class="p-1 rounded-xl group sm:flex space-x-6 bg-[#3f92d2] bg-opacity-50 shadow-xl hover:rounded-2xl">
                    ...
                    <div class='grid gap-12 lg:grid-cols-3'>
                        ...
                        <header>
                            <div class="sm:w-7/12 pl-0 p-5">
                                ...
                                <h4 class='text-blue-200 text-4xl font-extrabold'>{number}</h4>
                        </header>
                        <header>
                            <p class='text-blue-200 font-semibold mb-0 pt-12'>{category}</p>
                            <p class='text-blue-200 font-semibold mb-0 pt-1'>Born: {born}</p>
                            <p class='text-blue-200 font-semibold mb-0 pt-1'>Birthplace: {birthplace}</p>
                            <p class='text-blue-200 font-semibold mb-0 pt-1'>Shoots: {shoots}</p>
                        </header>
                        </div>
                    </div>
                </div>
                <div class='place-items-center'>
                    <div class='container mx-auto px-4 place-self-center'>
                        ...
                        {readBio ? <p class='mx-auto mt-4 px-4 py-2 tracking-wide 
